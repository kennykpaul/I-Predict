 ...
 */
public class TeamenteredAdapter extends ArrayAdapter<Teamentered> {

    Context context;
    private ArrayList<Teamentered> teams;

    public TeamenteredAdapter(Context context, int textViewResourceId, ArrayList<Teamentered> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (v == null) {
            ...
            v = vi.inflate(R.layout.team_selection, null);
        }
        Teamentered o = teams.get(position);
        if (o != null) {
